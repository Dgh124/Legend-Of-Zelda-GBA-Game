...
This project is a Game Boy Advance mini-game boss fight between Link and Ganon. The game is written in C and is built with the CS 2110 GBA toolchain inside Docker. The included Makefile builds the ROM as `App.gba` and launches it with mGBA through the CS 2110 Docker environment. Watch a youtube demonstration of the game here!

https://www.youtube.com/watch?v=h5BeoZ7C3f8

<img width="2242" height="1490" alt="image" src="https://github.com/user-attachments/assets/c65b96e8-7aa8-40ef-bf75-6e694d00555f" />

<img width="1110" height="747" alt="Screenshot 2026-06-16 at 2 24 27 PM" src="https://github.com/user-attachments/assets/50d020c2-51b4-4cff-9236-6aa4284f3e2c" />
